...
| [Configuring Toolbar controls](api/config/toolbar_items_config.md)| Learn how to configure, customize and reorder Toolbar contols ([Example](https://snippet.dhtmlx.com/s5r5h4ju?text=kanban)) |
