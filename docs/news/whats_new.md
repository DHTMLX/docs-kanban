...
:::info
Starting from v1.7 you can leverage JavaScript Kanban within Salesforce environment. Refer to the following guide for more information: [**Integration with Salesforce**](guides/integration_with_salesforce.md). You can also explore our [**GitHub example**](https://github.com/DHTMLX/salesforce-lwc-demo) or run [**Online demo**](https://dhtmlx-dev-ed.develop.lightning.force.com/) (*Login*: ***user***, *Password*: ***demo***).
:::
