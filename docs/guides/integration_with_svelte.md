...
:::tip
It's helpful to have a basic understanding of **Svelte** before jumping into this guide. For a quick refresher, check out the [**Svelte documentation**](https://svelte.dev/).
:::
