...
| [Loading card data dynamically](api/methods/js_kanban_setconfig_method.md)   | `setConfig()`(또는 별칭 [`parse()`](api/methods/js_kanban_parse_method.md))를 통해 런타임에 카드 데이터를 로드하는 방법을 알아보세요|
...
| [Configuring the editor](guides/configuration.md#configure-editor-behavior)| 에디터 설정 방법을 알아보세요           |
...
| [Loading column data dynamically](api/methods/js_kanban_setconfig_method.md)     | `setConfig()`(또는 별칭 [`parse()`](api/methods/js_kanban_parse_method.md))를 통해 런타임에 컬럼 데이터를 로드하는 방법을 알아보세요|
...
## 행(스윔레인) 작업 방법 {#how-to-work-with-rows-swimlanes}
...
| [Loading row data dynamically](api/methods/js_kanban_setconfig_method.md)       | `setConfig()`(또는 별칭 [`parse()`](api/methods/js_kanban_parse_method.md))를 통해 런타임에 행 데이터를 로드하는 방법을 알아보세요|
