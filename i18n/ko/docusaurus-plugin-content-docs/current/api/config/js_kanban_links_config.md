...
description: DHTMLX Kanban의 links 구성 API를 읽어보세요. 카드 간 작업 의존성 및 링크 데이터를 정의하는 방법을 알아볼 수 있습니다.
---
...
:::info
링크에 대한 새 데이터를 동적으로 로드하려면 [**setConfig()**](api/methods/js_kanban_setconfig_method.md) 또는 [**parse()**](api/methods/js_kanban_parse_method.md) 메서드를 사용할 수 있습니다!
:::
