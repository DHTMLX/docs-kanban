...
title: Руководство по стилизации Kanban
description: Ознакомьтесь с руководством по стилизации DHTMLX Kanban. Узнайте, как стилизовать карточки, колонки и строки с помощью CSS-классов и CSS-переменных.
---
