...
title: Руководство по кастомизации Kanban
description: Используйте руководства по кастомизации DHTMLX Kanban для изменения шаблонов, меню, карточек, колонок и поведения доски с помощью документированных шаблонов API.
---
