...
title: Руководство по локализации Kanban
description: Ознакомьтесь с руководством по локализации DHTMLX Kanban. Узнайте о настройке локалей, языковых пакетах, использовании setLocale и настройке многоязычного интерфейса.
---
