...
title: Руководство по интеграции Kanban с Angular
description: Следуйте руководству по интеграции DHTMLX Kanban с Angular. Узнайте о настройке компонентов, конфигурации, использовании API и структуре проекта.
---
