...
title: Руководство по конфигурации Kanban
description: Читайте руководство по конфигурации DHTMLX Kanban. Узнайте, как настраивать карточки, колонки, строки, редактор, панель инструментов и другие элементы доски.
---
...
### Привязка полей редактора к полям карточки {#bind-editor-fields-to-card-fields}
