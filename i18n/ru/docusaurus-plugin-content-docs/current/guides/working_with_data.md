...
title: Руководство по разбору данных Kanban
description: Ознакомьтесь с руководством по работе с данными DHTMLX Kanban. Узнайте, как загружать, читать, экспортировать и обновлять карточки, колонки, строки, связи и комментарии на доске.
---
...
Информацию об интеграции с несколькими виджетами см. в разделе [Интеграция с виджетами DHTMLX](guides/integration.md#gantt-event-calendar-and-to-do-list).
