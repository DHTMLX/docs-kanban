...
title: Руководство по серверной интеграции Kanban
description: Ознакомьтесь с руководством по серверной интеграции DHTMLX Kanban. Узнайте о провайдерах данных REST, синхронизации с backend, удалённых событиях и настройке API.
---
