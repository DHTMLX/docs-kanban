...
title: Руководство по инициализации Kanban
description: Следуйте руководству по инициализации DHTMLX Kanban. Узнайте о настройке конструктора, обязательных параметрах конфигурации, колонках, карточках и инициализации доски.
---
