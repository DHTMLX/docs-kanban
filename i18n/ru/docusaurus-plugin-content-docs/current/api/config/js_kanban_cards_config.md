---
sidebar_label: cards
title: API конфигурации cards
description: Ознакомьтесь с API конфигурации cards для DHTMLX Kanban. Узнайте, как задавать данные карточек задач, поля, статусы и содержимое доски.
---
