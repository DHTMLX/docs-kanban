...
- Тип ***dateRange*** добавлен в v1.3
- Типы редактора ***comments*** и ***links***, а также параметр ***format*** добавлены в v1.4
- Параметр ***modalSection*** добавлен в v1.6
- Параметр ***clearButton*** заменён на ***clear***

**Полезные статьи:** [Конфигурация](guides/configuration.md/#editor)
