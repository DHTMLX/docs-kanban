---
sidebar_label: rows
title: API конфигурации rows
description: Ознакомьтесь с API конфигурации rows для DHTMLX Kanban. Узнайте, как определять swimlanes, метки строк, лимиты и горизонтальную группировку доски.
---
