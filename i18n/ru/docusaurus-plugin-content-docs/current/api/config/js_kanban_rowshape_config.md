...
title: API конфигурации rowShape
description: Ознакомьтесь с API конфигурации rowShape для DHTMLX Kanban. Узнайте, как настраивать заголовки и меню строк-swimlanes.
---
...
**Журнал изменений:**
- Параметр ***css*** был добавлен в v1.4
- Параметр ***menu.items[0].label*** устарел и был заменён на ***menu.items[0].text*** в v1.4
- Параметр ***menu.items[0].items*** устарел и был заменён на ***menu.items[0].data*** в v1.4
- Параметры ***menu.items[0].label*** и ***menu.items[0].items*** были удалены в v1.7
- Функция ***menu.items*** была обновлена. Параметр **store** был заменён на **readonly** в v1.7
