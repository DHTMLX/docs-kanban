...
title: API конфигурации locale
description: Ознакомьтесь с API конфигурации locale для DHTMLX Kanban. Узнайте, как применить пользовательскую локаль к интерфейсу доски.
---
