---
sidebar_label: links
title: API конфигурации links
description: Ознакомьтесь с API конфигурации links для DHTMLX Kanban. Узнайте, как определять зависимости задач и данные связей между карточками.
---
...
**Журнал изменений:** Свойство обновлено в v1.7:
    - Параметр **masterId** заменён на **source**
    - Параметр **slaveId** заменён на **target**

**Полезные статьи:** [Работа с данными](guides/working_with_data.md)
