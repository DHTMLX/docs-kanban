...
- объект параметров конфигурации ([см. здесь](#kanban-properties))
...
- HTML контейнер (ID HTML контейнера)
- объект параметров конфигурации ([см. здесь](#toolbar-properties))
...
## Свойства Kanban {#kanban-properties}
