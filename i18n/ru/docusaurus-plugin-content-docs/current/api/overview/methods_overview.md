...
title: Обзор методов
description: Ознакомьтесь с обзором методов DHTMLX Kanban. Найдите все методы доски для добавления, обновления, перемещения и удаления карточек, колонок и строк.
---
