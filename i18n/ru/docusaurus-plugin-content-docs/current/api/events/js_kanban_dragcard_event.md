...
title: API события drag-card
description: Ознакомьтесь с API события drag-card для DHTMLX Kanban. Узнайте, как обрабатывать событие, срабатывающее при перемещении карточки через dnd.
---
