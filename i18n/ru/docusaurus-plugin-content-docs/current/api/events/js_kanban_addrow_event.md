...
title: API события add-row
description: Ознакомьтесь с API события add-row для DHTMLX Kanban. Узнайте, как обрабатывать событие, срабатывающее при добавлении новой строки.
---
...
**Журнал изменений:** параметры **id**, **before** и **row** были добавлены в v1.1