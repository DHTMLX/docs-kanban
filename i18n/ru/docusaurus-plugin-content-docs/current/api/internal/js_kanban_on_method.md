...
title: API метода on
description: Ознакомьтесь с API метода on для DHTMLX Kanban. Узнайте, как подписываться на события доски и обрабатывать действия пользователя в вашем приложении.
---
