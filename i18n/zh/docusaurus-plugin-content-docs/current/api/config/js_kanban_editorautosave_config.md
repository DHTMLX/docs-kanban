...
:::danger
从 v1.3 起，`editorAutoSave` 属性已被**弃用**。要管理"自动保存"模式，请使用 [`editor`](api/config/js_kanban_editor_config.md) 属性！
:::
...
:::info
通过此参数，您可以启用或禁用 Kanban 的自动保存模式。如果将 **editorAutoSave** 属性设置为 **false**，编辑器将显示"保存"按钮以保存编辑的数据。
:::
