...
Das war's! Nur drei einfache Schritte und Sie verfügen über ein praktisches Tool zur Visualisierung und Verwaltung Ihres Workflows. Jetzt können Sie mit Ihren Aufgaben arbeiten oder die Möglichkeiten von JavaScript Kanban weiter erkunden. Sie entwickeln mit einem KI-Coding-Assistenten? Verweisen Sie ihn über den [DHTMLX MCP-Server](guides/mcp-server.md) auf die aktuelle Dokumentation.