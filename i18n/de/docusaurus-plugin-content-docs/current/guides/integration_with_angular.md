...
Laden Sie das [**Trial-Kanban-Paket**](/how_to_start/#installing-kanban-via-npm-or-yarn) herunter und folgen Sie den Schritten in der README-Datei. Beachten Sie, dass das Trial-Kanban nur 30 Tage verfügbar ist.
