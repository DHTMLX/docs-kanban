...
title: getState Methode API
description: Lesen Sie die API der getState-Methode für DHTMLX Kanban. Erfahren Sie, wie Sie auf den aktuellen Board-Zustand, Karten, Links und die Konfiguration zugreifen.
---
