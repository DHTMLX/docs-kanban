...
title: getReactiveState Methode API
description: Lesen Sie die API der getReactiveState-Methode für DHTMLX Kanban. Erfahren Sie, wie Sie ein Objekt mit den reaktiven Eigenschaften des Boards abrufen.
---
