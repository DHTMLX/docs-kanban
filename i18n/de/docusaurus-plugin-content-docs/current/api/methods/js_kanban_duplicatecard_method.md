...
title: duplicateCard Methode API
description: Lesen Sie die API-Dokumentation der Methode duplicateCard für DHTMLX Kanban. Erfahren Sie, wie Sie eine Karte anhand ihrer ID duplizieren.
---
