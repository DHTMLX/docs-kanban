...
title: Toolbar setLocale Methode API
description: Lesen Sie die Toolbar setLocale Method API für DHTMLX Kanban. Erfahren Sie, wie Sie eine neue Locale auf die Toolbar anwenden.
---
