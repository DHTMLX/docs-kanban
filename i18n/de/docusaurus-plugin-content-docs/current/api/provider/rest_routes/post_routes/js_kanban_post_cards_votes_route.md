...
description: Lesen Sie die REST-Route POST /cards/{cardId}/vote API für DHTMLX Kanban. Erfahren Sie, wie Sie einer Karte eine Stimme hinzufügen und die ID des abstimmenden Benutzers zurückgeben.
---
