...
title: delete-comment Ereignis API
description: Lesen Sie die delete-comment Event API für DHTMLX Kanban. Erfahren Sie, wie Sie das Event behandeln, das beim Löschen eines Kartenkommentars ausgelöst wird.
---
