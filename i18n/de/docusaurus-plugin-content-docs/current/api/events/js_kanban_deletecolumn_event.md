...
title: delete-column Ereignis API
description: Lesen Sie die delete-column Event API für DHTMLX Kanban. Erfahren Sie, wie Sie das Event behandeln, das beim Entfernen einer Spalte ausgelöst wird.
---
