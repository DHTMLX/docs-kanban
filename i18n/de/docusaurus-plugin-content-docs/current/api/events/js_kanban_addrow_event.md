...
title: add-row Ereignis API
description: Lesen Sie die add-row Event API für DHTMLX Kanban. Erfahren Sie, wie Sie das Event behandeln, das beim Hinzufügen einer neuen Zeile ausgelöst wird.
---
