...
title: move-card Ereignis API
description: Lesen Sie die move-card Event API für DHTMLX Kanban. Erfahren Sie, wie Sie das Event behandeln, das beim Verschieben einer Karte ausgelöst wird.
---
