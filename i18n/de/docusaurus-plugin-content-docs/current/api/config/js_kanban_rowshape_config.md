...
**Changelog:**
- Der Parameter ***css*** wurde in v1.4 hinzugefügt
...
- Die Funktion ***menu.items*** wurde aktualisiert. Der **store**-Parameter wurde in v1.7 durch den **readonly**-Parameter ersetzt
