...
title: cardShape Konfiguration API
description: Lesen Sie die cardShape Konfigurations-API für DHTMLX Kanban. Erfahren Sie, wie Sie Kartenfelder, Layout, Menüs und visuelle Kartenoptionen steuern.
---
