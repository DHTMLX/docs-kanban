...
const SITE_NAME = 'DHTMLX Kanban Docs';
const PRODUCT_NAME = 'DHTMLX Kanban';
const PRODUCT_URL = 'https://dhtmlx.com/docs/products/dhtmlxKanban/';

function resolveType(pathname) {
    const path = (pathname || '').replace(/\/+$/, '');
    if (path === '' || path === '/kanban') return 'SoftwareApplication';
